...
export default function Landing() {
  ...
  // Whole days between the last collected date and today.
  const staleDays = cov?.last_date
    ? Math.max(0, Math.round((Date.now() - new Date(`${cov.last_date}T00:00:00`)) / 86_400_000))
    : null;
      ...
      <footer className="border-t border-border">
        <div className="mx-auto grid max-w-[80rem] grid-cols-2 gap-8 px-4 py-10 md:grid-cols-4 md:px-8">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link to="/overview" className="text-muted-foreground hover:text-foreground">Overview</Link></li>
              ...
              <li><Link to="/tariffs" className="text-muted-foreground hover:text-foreground">Data Sources</Link></li>
            </ul>
          </div>
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Data &amp; Provenance</p>
            <ul className="mt-3 space-y-2 text-sm">
              <li><Link to="/data" className="text-muted-foreground hover:text-foreground">Collection Log</Link></li>
              <li><Link to="/validation" className="text-muted-foreground hover:text-foreground">Validation vs MoSPI</Link></li>
              <li><Link to="/cleaning" className="text-muted-foreground hover:text-foreground">Cleaning Methodology</Link></li>
              <li><Link to="/split" className="text-muted-foreground hover:text-foreground">Base Fare &amp; Taxes</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              ...
              <li><Link to="/methodology" className="text-muted-foreground hover:text-foreground">About</Link></li>
            </ul>
          </div>
        </div>
        <div className="border-t border-border">
          <div className="mx-auto flex max-w-[80rem] flex-wrap items-center justify-between gap-3 px-4 py-4 text-xs text-muted-foreground md:px-8">
            <span>&copy; {new Date().getFullYear()} APIx &middot; Built for Smart India Hackathon 2026 &middot; Problem Statement 26056 &middot; MoSPI</span>
